...
for epoch in range(epochs):
    ...
    np.save("./outputs/{info}_CRNN_epoch_training_losses.npy", A)
    np.save("./outputs/{info}_CRNN_epoch_training_scores.npy", B)
    np.save("./outputs/{info}_CRNN_epoch_test_loss.npy", C)
    np.save("./outputs/{info}_CRNN_epoch_test_score.npy", D)
...
plt.ylabel("accuracy")
plt.legend(["train", "test"], loc="upper left")
title = "./{info}_fig_UCF101_ResNetCRNN.png"
