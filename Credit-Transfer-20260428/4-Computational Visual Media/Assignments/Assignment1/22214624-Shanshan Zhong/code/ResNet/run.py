...
), "Dataset can only be cifar10 or cifar100 or stl10."
...
def main():
    ...
    if args.dataset == "stl10":
        trainset = datasets.STL10(
            root="../datasets", download=True, split="train", transform=transform_stl
        )
        testset = datasets.STL10(
            root="../datasets",
            download=True,
            split="test",
            transform=transform_stl_test,
        )

        batchsize = 16
        # batchsize = args.train_batch
